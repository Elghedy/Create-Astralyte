...
public enum ModArmorMaterials implements ArmorMaterial {
    ASTRALYTE("astralyte", 41, new int[]{ 4, 9, 7, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 4f, 0.15f, () -> Ingredient.of(ModItems.ASTRALYTE_INGOT.get()));
    ...
    public String getName() {
        return AstralyteMod.MOD_ID + ":" + this.name;
    }
